...
{
    /**
     * Get or create a chat for the authenticated customer with real-time support info
     */
            ...
            return response()->json([
                ...
                'data' => [
                    'chat' => [
                        ...
                        'channel_name' => 'chat.' . $chat->id, // Add channel name for real-time
                        'event_name' => 'message.new' // Add event name for real-time
                    ],
    ...
    /**
     * Send a chat message with real-time support
     */
    public function sendMessage(Request $request): JsonResponse
    {
        try {
            ...
            // Note: NewChatMessage event is triggered automatically in the ChatMessage model
    ...
    /**
     * Get chat messages with pagination with real-time support info
     */
