...
@section('title', 'إضافة فئة مستخدمين جديدة')
...
<div class="page-header">
    <nav class="breadcrumb">
        ...
        <div class="breadcrumb-item active">إضافة فئة جديدة</div>
    </nav>
    
    <h1 class="page-title">
        <i class="fas fa-plus-circle"></i>
        إضافة فئة مستخدمين جديدة
    </h1>
    <p class="page-subtitle">إنشاء فئة جديدة لتصنيف العملاء حسب معدل الشراء</p>
</div>
...
<form method="POST" action="{{ route('admin.user-categories.store') }}" id="categoryForm">
    @csrf
            ...
            <div class="form-grid">
                <div class="form-group">
                    ...
                    <input type="text" id="name" name="name" class="form-control" 
                           value="{{ old('name') }}" placeholder="A, B, C, VIP..."
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="sort_order" name="sort_order" class="form-control" 
                           value="{{ old('sort_order', 1) }}" min="0" required>
                ...
                <div class="form-group full-width">
                    ...
                    <input type="text" id="display_name" name="display_name" class="form-control" 
                           value="{{ old('display_name') }}" placeholder="فئة A - عملاء مميزين"
                           required>
                ...
                <div class="form-group full-width">
                    ...
                    <input type="text" id="display_name_en" name="display_name_en" class="form-control" 
                           value="{{ old('display_name_en') }}" placeholder="Category A - Premium Customers">
                ...
                <div class="form-group full-width">
                    ...
                    <textarea id="description" name="description" class="form-control" rows="3" 
                              placeholder="وصف تفصيلي للفئة ومميزاتها...">{{ old('description') }}</textarea>
    ...
    <div class="form-section">
        ...
        <div class="section-body">
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="number" id="min_cartons" name="min_cartons" 
                               class="form-control" value="{{ old('min_cartons', 0) }}" 
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="number" id="max_cartons" name="max_cartons" 
                               class="form-control" value="{{ old('max_cartons') }}" 
                               min="0" step="1">
                        <div class="input-addon">كرتون</div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="number" id="carton_loyalty_points" name="carton_loyalty_points" 
                               class="form-control" value="{{ old('carton_loyalty_points', 10) }}" 
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="number" id="bonus_points_per_carton" name="bonus_points_per_carton" 
                               class="form-control" value="{{ old('bonus_points_per_carton', 0) }}" 
                               min="0" step="1">
                        <div class="input-addon">نقطة</div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="number" id="monthly_bonus_points" name="monthly_bonus_points" 
                               class="form-control" value="{{ old('monthly_bonus_points', 0) }}" 
                               min="0" step="1">
                        <div class="input-addon">نقطة</div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="number" id="signup_bonus_points" name="signup_bonus_points" 
                               class="form-control" value="{{ old('signup_bonus_points', 0) }}" 
                               min="0" step="1">
                        <div class="input-addon">نقطة</div>
                    </div>
                ...
                <div class="form-group">
                    <label class="checkbox-label">
                        <input type="checkbox" id="has_points_multiplier" name="has_points_multiplier" 
                               value="1" {{ old('has_points_multiplier') ? 'checked' : '' }}>
                ...
                <div class="form-group" id="multiplier_group" style="display: none;">
                    <label for="points_multiplier">
                        مضاعف النقاط
                    </label>
                    <div class="input-group">
                        <input type="number" id="points_multiplier" name="points_multiplier" 
                               class="form-control" value="{{ old('points_multiplier', 1.5) }}" 
                ...
                <div class="form-group">
                    <label class="checkbox-label">
                        <input type="checkbox" id="requires_carton_purchase" name="requires_carton_purchase" 
                               value="1" {{ old('requires_carton_purchase') ? 'checked' : '' }}>
                        <span class="checkmark"></span>
                ...
                <input type="hidden" name="min_packages" value="0">
                <input type="hidden" name="max_packages" value="">
                <input type="hidden" name="requires_package_purchase" value="0">
        ...
        <div class="section-body">
            <div class="preview-section" id="categoryPreview">
                ...
                <div class="preview-details" id="previewDetails">
                    <div>نطاق الشراء: 0 - غير محدد</div>
                    <div>خصم: 0%</div>
                </div>
            </div>
        </div>
