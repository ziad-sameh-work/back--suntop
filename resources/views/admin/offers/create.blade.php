...
<div class="page-header">
    ...
    <p class="page-subtitle">إنشاء عرض ترويجي أو كود خصم جديد</p>
</div>

<form action="{{ route('admin.offers.store') }}" method="POST" enctype="multipart/form-data" class="form-container">
    @csrf
    ...
    <div class="form-content">
            ...
            <div class="form-grid">
                ...
                <div class="form-group full-width">
                    ...
                    <textarea name="description" class="form-control" rows="3" 
                              placeholder="وصف تفصيلي للعرض وشروط الاستخدام...">{{ old('description') }}</textarea>
        ...
        <div class="form-section">
            ...
            <div class="discount-options">
                <div class="discount-option {{ old('type') === 'percentage' || !old('type') ? 'selected' : '' }}" 
                ...
                <div class="discount-option {{ old('type') === 'fixed_amount' ? 'selected' : '' }}" 
                     onclick="selectDiscountType('fixed_amount')">
                    <input type="radio" name="type" value="fixed_amount" 
                           {{ old('type') === 'fixed_amount' ? 'checked' : '' }}>
                    <div class="discount-option-icon">
            ...
            <div class="form-grid">
                <div class="form-group">
                    ...
                    <input type="datetime-local" name="valid_from" class="form-control" 
                           value="{{ old('valid_from', now()->format('Y-m-d\TH:i')) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input type="datetime-local" name="valid_until" class="form-control" 
                           value="{{ old('valid_until', now()->addMonth()->format('Y-m-d\TH:i')) }}" required>
