...
@push('styles')
<style>
    .create-merchant-container { max-width: 1000px; margin: 0 auto; }
    ...
    .form-header { text-align: center; margin-bottom: 30px; padding-bottom: 20px; border-bottom: 1px solid var(--gray-100); }
    .form-header h2 { font-size: 24px; font-weight: 600; color: var(--gray-800); margin: 0 0 10px 0; }
    ...
    @media (max-width: 768px) { .form-grid { grid-template-columns: 1fr; } .form-actions { flex-direction: column; } .create-merchant-container { padding: 0 15px; } }
</style>
@endpush
...
<div class="create-merchant-container">
    <div class="form-card">
        <div class="form-header">
            ...
            <p>أدخل بيانات التاجر الجديد للانضمام للمنصة</p>
        </div>

        <div class="info-box">
            <i class="fas fa-info-circle"></i>
            <div><strong>ملاحظة:</strong> جميع البيانات المطلوبة يجب أن تكون صحيحة ومكتملة لضمان تفعيل التاجر بنجاح.</div>
        </div>

        <form method="POST" action="{{ route('admin.merchants.store') }}" enctype="multipart/form-data" id="createMerchantForm">
            @csrf
            ...
            <div class="form-sections">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-input" 
                                   value="{{ old('name') }}" required placeholder="أدخل اسم التاجر">
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" name="phone" class="form-input" 
                                   value="{{ old('phone') }}" required placeholder="مثل: 01000000000">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="city" class="form-input" 
                                   value="{{ old('city') }}" required placeholder="أدخل المدينة">
                        ...
                        <div class="form-group full-width">
                            ...
                            <textarea name="address" class="form-textarea" 
                                      required placeholder="أدخل العنوان التفصيلي للمحل">{{ old('address') }}</textarea>
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text" name="business_name" class="form-input" 
                                   value="{{ old('business_name') }}" required placeholder="أدخل اسم المحل">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="business_type" class="form-input" 
                                   value="{{ old('business_type') }}" placeholder="مثل: مطعم، متجر ملابس، إلخ">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="commission_rate" class="form-input" 
                                   value="{{ old('commission_rate', 5) }}" required step="0.1" min="0" max="100" placeholder="5.0">
                        ...
                        <div class="form-group full-width">
                            ...
                            <textarea name="description" class="form-textarea" 
                                      placeholder="اكتب وصفاً مختصراً عن المحل ونوع المنتجات التي يقدمها">{{ old('description') }}</textarea>
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        <label class="form-label">رفع شعار المحل</label>
                        <div class="logo-upload" onclick="document.getElementById('merchantLogo').click()">
                            ...
                            <div class="upload-content">
                                ...
                                <p class="upload-text">اضغط لاختيار شعار المحل أو اسحب الصورة هنا</p>
                        ...
                        <div class="logo-preview" id="logoPreview">
                            <img id="logoImage" src="" alt="معاينة الشعار">
                        </div>
...
document.getElementById('createMerchantForm').addEventListener('submit', function(e) {
    ...
    setTimeout(() => {
        ...
        submitBtn.innerHTML = '<i class="fas fa-save"></i> إضافة التاجر';
    }, 10000);
});
